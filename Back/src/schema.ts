...
export const typeDefs = gql`
    ...
    type Mutation{
        ...
        createUser(nombre: String!, apellido1: String!, apellido2: String!, telefono: String!, contrasena: String!, correo: String!, horasSemanales: Float!, diasHabiles: Float!): Persona
